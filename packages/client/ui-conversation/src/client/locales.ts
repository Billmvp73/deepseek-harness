...
export const zh = {
  ...
  'hero.newWorktree': '新建 worktree',
  'header.worktree': '此会话在此 worktree 分支中工作：{branch}',
...
export const en = {
  ...
  'hero.newWorktree': 'New worktree',
  'header.worktree': 'This session works in the worktree branch {branch}',
